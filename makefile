...
format:
	npx prettier --write index.html editor.html play.html main.js **/*.json config.json

check:
	npx jshint --extract=always index.html editor.html play.html main.js
	npx prettier --check index.html editor.html play.html main.js **/*.json config.json
